var DrawingEnvironment = function () {
  ...
  this.initHTML = function() {
    ...
    if(this.isResizable){
      ...
      resizableEnd = '<div class="resizer" style="width: 15px; height: 15px; background: #999999; position:absolute; right: -5; bottom: -5; cursor: se-resize; user-select: none;">  </div></div>';
    }
